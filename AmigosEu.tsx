        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-2 -right-2 w-3 h-3 bg-aqua-orange rounded-full animate-float opacity-70"></div>
              <div className="absolute top-6 -left-2 w-2 h-2 bg-aqua-blue rounded-full animate-float delay-1000 opacity-70"></div>
              <div className="absolute -bottom-2 right-4 w-2 h-2 bg-aqua-purple rounded-full animate-float delay-2000 opacity-70"></div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-aqua-blue">
              ...
              <div className="space-y-4 text-left max-w-md mx-auto">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-800">403 - Cora SCFI</span>
                </div>
